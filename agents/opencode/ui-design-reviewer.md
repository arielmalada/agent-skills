---
description: >-
  Reviews recently created or modified display/view components (e.g. .view.tsx
  files) against a 7-category framework: visual hierarchy, typography,
  color/contrast, accessibility (WCAG 2.1), component architecture,
...
<!-- Ported from ../claude-code/ui-design-reviewer.md — the Claude Code file is the source of truth; keep bodies in sync. -->
